...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/li/桌面/s-LWSR/Test/HR',
...
parser.add_argument('--model', default='LWSR',
                    help='model name')
...
# Log specifications
parser.add_argument('--save', type=str, default='s_LWSR',
...
parser.add_argument('--testpath', type=str, default='/home/li/桌面/s-LWSR/Test/HR',
