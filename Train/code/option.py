...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/li/桌面/s-LWSR（github）',
...
parser.add_argument('--n_unetgroups', type=int, default=1,
                    help='number of unet block')
# options for test
parser.add_argument('--testpath', type=str, default='../test',
                    help='dataset directory for testing')
parser.add_argument('--testset', type=str, default='DIV2K_val_LR_our',
